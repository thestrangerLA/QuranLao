    ...
    <div className="space-y-8 pb-20">
      ...
      >
        <div className="relative z-10 text-center space-y-4">
          <div className="arabic-text text-sm mb-2" dir="rtl">{surah.name_arabic}</div>
      ...
      {(surah.id !== 1 && surah.id !== 9) && (
        <div className="text-center py-8">
          <div className="arabic-text text-xs text-emerald-600" dir="rtl">
          ...
          filteredVerses.map((verse) => (
            ...
            >
              <div className="flex items-start gap-4 mb-6">
                <div className="flex-shrink-0 w-10 h-10 rounded-full border border-border flex items-center justify-center text-[10px] font-bold text-emerald-600 bg-card">
                  {verse.verse_number}
                </div>
                {showArabic && (
                  <div className="flex-1 text-right" dir="rtl">
                    <p className="arabic-text text-xs leading-[2.5] text-foreground">
