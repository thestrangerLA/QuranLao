...
export const anNaba: Verse[] = [
  {
    ...
    explanation: 'ຄືພວກມຸຊຮິກິນຊາວມັກກະຫຕ່າງກໍວິພາກວິຈານ ແລະ ຖາມເຖິງເລື່ອງຫຍັງກັນ , ຄວາມຈິງອັລລໍ ຊົງຮູ້ດີວ່າໃນສິ່ງທີ່ພວກເຂົາຖາມເຖິງນັ້ນຄືເລື່ອງຫຍັງ , ຄວາມມຸ່ງໝາຍຂອງການຖາມນີ້ເພື່ອໃຫ້ເຫັນເຖິງຄວາມສໍາຄັນຂອງເລື່ອງທີ່ພວກມຸຊຮິກິນກໍາລັງກ່າວຂັວນເຖິງ ຄືເລື່ອງຂອງການຟື້ນຄືນຊີວິດ , ເພາະພວກເຂົາປະຕິເສດ ບໍ່ເຊື່ອວ່າຈະມີຂຶ້ນຈິງ ແລະ ຍັງເຍາະເຍີ້ຍສໍາອີກ.'
  },
  {
    number: '2',
    arabic: 'عَنِ ٱلنَّبَإِ ٱلْعَظِيمِ',
    lao: '(ຖາມ) ເຖິງຂ່າວອັນຍິ່ງໃຫຍ່ສໍາຄັນ.',
  ...
  },
  {
    ...
    explanation: 'ຄືພວກມຸຊຮິກິນ ລວມທັງຜູ້ປະຕິເສດສັດທາໃນເລື່ອງນີ້ ຈະໄດ້ຮູ້ໄດ້ເຫັນດ້ວຍຕົນເອງ ເມື່ອແຕ່ລະຄົນໄດ້ຟື້ນຄືນຊີບຂຶ້ນມາ ແລະ ການລົງໂທດໄດ້ປະສົບແກ່ພວກເຂົາແລ້ວ , ພວກເຂົາຈະໄດ້ຮູ້ວ່າ ສິ່ງທີ່ພວກເຂົາຖາມເຖິງ ແລະ ເຍາະເຍີ້ຍກັນເປັນຄວາມຈິງທີ່ປາດສະຈາກຂໍ້ສົງໃສ່ໃດໆ ທັງສິ້ນ.'
  },
  {
    number: '6',
  ...
  },
  {
    ...
    explanation: 'ຄືເຮົາໄດ້ເຮັດໃຫ້ແຜ່ນດິນເປັນພື້ນທີ່ຮາບພຽງ ເພື່ອພວກເຂົາຈະໄດ້ພັກອາໃສ່ ແລະ ສັນຈອນໄປມາຕະຫຼອດຮອດພື້ນທີ່ຮາບພຽງເພື່ອການປູກຝັງພືດພັນນາໆ ຊະນິດ , ແລະ ເຮົາໄດ້ເຮັດໃຫ້ພູເຂົາເປັນຫຼັກຕຶງແຜ່ນດິນໄວ້ບໍ່ໃຫ້ເອນອ່ຽງ ເຊັ່ນດຽວກັບການສ້າງເຮືອນຂອງເຮົາ, ຈະຕ້ອງມີການຕອກເສົາເຂັມເພື່ອໃຫ້ເຮືອນມີຄວາມແຂງແຮງໝັ້ນຄົງ.'
  },
  {
    number: '8',
  ...
  },
  {
    ...
    explanation: 'ຄືເຮົາໄດ້ເຮັດໃຫ້ການນອນລັບເປັນການພັກຜ່ອນແກ່ຮ່າງກາຍຂອງພວກເຈົ້າ, ຫຼັງຈາກໄດ້ເຮັດວຽກຢ່າງລໍາບາກໃນເວລາກາງເວັນ.'
  },
  {
    number: '10',
