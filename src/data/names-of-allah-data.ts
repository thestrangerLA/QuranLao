...
export const namesOfAllahData: NameOfAllah[] = [
  ...
  { 
    ...
    description: [
      {
        title: "ຄວາມໝາຍ",
        content: "Allah ແມ່ນ Ar-Rahīm ຊຶ່ງໝາຍເຖິງ ພຣະຜູ້ຊົງກະລຸນາປານີສະເໝີ. ຊື່ນີ້ສະແດງເຖິງຄວາມເມດຕາພິເສດຂອງ Allah ທີ່ພຣະອົງໄດ້ປະທານໃຫ້ແກ່ຜູ້ສັດທາ. ຄວາມເມດຕານີ້ບໍ່ພຽງແຕ່ເປັນສິ່ງທົ່ວໄປເທົ່ານັ້ນ, ແຕ່ເປັນຄວາມເມດຕາທີ່ຄົງຢູ່ຕະຫຼອດໄປ ທັງໃນໂລກນີ້ ແລະ ໂລກໜ້າ."
      },
      {
      ...
      {
        title: "ໃນອັລກຸຣອານ",
        content: "Allah ຊົງກ່າວວ່າ:\n**“ແທ້ຈິງແລ້ວ Allah ຊົງເປັນຜູ້ໃຫ້ອະໄພ ແລະ ເມດຕາກະລຸນາສະເໝີ.” (ອັລກຸຣອານ 2:199)**"
      },
      {
        title: "ສຳລັບຊາວມຸດສະລິມໃໝ່",
      ...
      {
        title: "✨ ຂໍ້ຄິດທີ່ເຂົ້າໃຈງ່າຍ",
        content: "Ar-Rahīm ໝາຍເຖິງຄວາມເມດຕາຂອງ Allah ທີ່ພິເສດ ແລະ ຕໍ່ເນື່ອງສຳລັບຜູ້ສັດທາ. ຄວາມເມດຕານີ້ຈະຕາມໄປເຖິງໂລກໜ້າ ແລະ ເປັນກຸນແຈສູ່ສວນສະຫວັນ."
      }
    ]
  },
