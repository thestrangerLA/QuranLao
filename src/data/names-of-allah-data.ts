...
export const namesOfAllahData: NameOfAllah[] = [
  { 
    ...
    description: [
      {
        title: "ຄວາມໝາຍ",
        content: "ອັລລໍຮ໌ ຄື Ar-Rahmān, ເຊິ່ງໝາຍເຖິງ ພຣະຜູ້ຊົງເມດຕາຍິ່ງ, ພຣະຜູ້ຊົງໂປດປານ. ຊື່ນີ້ສະແດງໃຫ້ເຫັນວ່າຄວາມເມດຕາ ແລະ ຄວາມກະລຸນາຂອງອັລລໍຮ໌ ມີໄວ້ໃຫ້ສຳລັບທຸກຄົນໃນໂລກ—ທັງຊາວມຸດສະລິມ ແລະ ບໍ່ແມ່ນມຸສລິມ, ຄົນດີ ແລະ ແມ້ແຕ່ຄົນບາບ. ຄວາມເມດຕາຂອງພຣະອົງກວ້າງໃຫຍ່ຈົນກວມເອົາທຸກສິ່ງທີ່ມີຊີວິດ: ມະນຸດ, ສັດ, ພືດ, ທຸກສິ່ງທຸກຢ່າງ."
      },
      {
      ...
      {
        title: "ໃນ Quran",
        content: "ອັລລໍຮ໌ ກ່າວວ່າ: **“ຄວາມເມດຕາຂອງຂ້ອຍກວມເອົາທຸກສິ່ງ.” (Quran 7:156)**\nນີ້ໝາຍຄວາມວ່າບໍ່ມີຫຍັງຢູ່ນອກເໜືອຄວາມເມດຕາຂອງ Allah."
      },
      {
        title: "ສຳລັບຊາວມຸດສະລິມໃໝ່",
        content: "- ຈົ່ງຈື່ໄວ້: ອັລລໍຮ໌ ບໍ່ໄດ້ຮ້າຍກາດຫຼືໂຫດຮ້າຍ. ພຣະອົງຊົງເມດຕາ, ຮັກ ແລະ ຫ່ວງໃຍ.\n- ເມື່ອທ່ານກ່າວ Bismillāh ir-Rahmān ir-Raheem (ໃນນາມຂອງອັລລໍຮ໌, ພຣະຜູ້ຊົງເມດຕາຍິ່ງ, ພຣະຜູ້ຊົງກະລຸນາ), ທ່ານຈະເຕືອນຕົນເອງວ່າຄວາມເມດຕາຂອງອັລລໍຮ໌ ຢູ່ກັບທ່ານສະເໝີ.\n- ບໍ່ວ່າອະດີດຂອງທ່ານຈະເປັນແນວໃດ, ຄວາມເມດຕາຂອງອັລລໍຮ໌ ຍິ່ງໃຫຍ່ກວ່າຄວາມຜິດພາດຂອງທ່ານ. ການກັບຄືນສູ່ພຣະອົງຈະນຳທ່ານມາຢູ່ພາຍໃຕ້ການດູແລຂອງພຣະອົງ."
      },
      {
  ...
  { 
    ...
    translation: "ຜູ້ຊົງເມດຕາເປັນນິດ",
    description: [
      {
        title: "ຄວາມໝາຍ",
        content: "ອັລລໍຮ໌ ແມ່ນ Ar-Rahīm ຊຶ່ງໝາຍເຖິງ ພຣະຜູ້ຊົງກະລຸນາປານີສະເໝີ. ຊື່ນີ້ສະແດງເຖິງຄວາມເມດຕາພິເສດຂອງອັລລໍຮ໌ ທີ່ພຣະອົງໄດ້ປະທານໃຫ້ແກ່ຜູ້ສັດທາ. ຄວາມເມດຕານີ້ບໍ່ພຽງແຕ່ເປັນສິ່ງທົ່ວໄປເທົ່ານັ້ນ, ແຕ່ເປັນຄວາມເມດຕາທີ່ຄົງຢູ່ຕະຫຼອດໄປ ທັງໃນໂລກນີ້ ແລະ ໂລກໜ້າ."
      },
      {
        title: "ຕົວຢ່າງຄວາມເມດຕາຂອງ Ar-Rahīm",
        content: "- ພຣະອົງຊົງໃຫ້ອະໄພແກ່ຜູ້ສັດທາທີ່ຮູ້ສຳນຶກຜິດ ແລະ ກັບຄືນຫາພຣະອົງ.\n- ພຣະອົງຊົງຊີ້ທາງດ້ວຍ ອັລກຸຣອານ (Al-Quran) ແລະ ສົ່ງບັນດານະບີ (ສາດສະດາ) ມາເປັນຜູ້ນຳທາງ.\n- ພຣະອົງຊົງສັນຍາກັບຜູ້ສັດທາວ່າຈະໄດ້ເຂົ້າສູ່ສວນສະຫວັນນິຣັນດອນ."
      },
      {
        title: "ໃນອັລກຸຣອານ",
        content: "ອັລລໍຮ໌ ຊົງກ່າວວ່າ:\n**“ແທ້ຈິງແລ້ວ ອັລລໍຮ໌ ຊົງເປັນຜູ້ໃຫ້ອະໄພ ແລະ ເມດຕາກະລຸນາສະເໝີ.” (ອັລກຸຣອານ 2:199)**"
      },
      {
        title: "ສຳລັບຊາວມຸດສະລິມໃໝ່",
        content: "- ຈົ່ງໝັ້ນໃຈວ່າ ຫາກທ່ານເຮັດຜິດແລ້ວກັບຄືນສູ່ພຣະອົງ, ພຣະອົງພ້ອມທີ່ຈະໃຫ້ອະໄພ.\n- ຄວາມເມດຕາໃນ Ar-Rahīm ແມ່ນພິເສດສະເພາະສຳລັບຜູ້ທີ່ສັດທາ ແລະ ພະຍາຍາມເຮັດຄວາມດີ.\n- ການລະໝາດ (ການອະທິຖານ), ການອ່ານອັລກຸຣອານ ແລະ ການຂໍດູອາ (ການຂໍພອນ) ແມ່ນວິທີເຊື່ອມໂຍງຕົວທ່ານກັບຄວາມເມດຕາຂອງພຣະອົງ."
      },
      {
        title: "✨ ຂໍ້ຄິດທີ່ເຂົ້າໃຈງ່າຍ",
        content: "Ar-Rahīm ໝາຍເຖິງຄວາມເມດຕາຂອງອັລລໍຮ໌ທີ່ພິເສດ ແລະ ຕໍ່ເນື່ອງສຳລັບຜູ້ສັດທາ. ຄວາມເມດຕານີ້ຈະຕາມໄປເຖິງໂລກໜ້າ ແລະ ເປັນກຸນແຈສູ່ສວນສະຫວັນ."
      }
    ]
  },
  { 
    ...
    translation: "ຜູ້ຊົງເປັນກະສັດ",
    description: [
      {
        title: "ຄວາມໝາຍ",
        content: "ອັລລໍຮ໌ (Allah) ແມ່ນ Al-Malik ຊຶ່ງໝາຍເຖິງ ພຣະຜູ້ຊົງເປັນກະສັດສູງສຸດ, ພຣະຜູ້ຊົງອຳນາດເດັດຂາດເໜືອທຸກສິ່ງທຸກຢ່າງໃນຈັກກະວານ. ບໍ່ມີໃຜສາມາດຂັດຄ້ານ ຫຼືແບ່ງປັນອຳນາດກັບພຣະອົງໄດ້. ທຸກສິ່ງທີ່ມີຢູ່ເປັນພຽງສິ່ງຖືກສ້າງຂຶ້ນ ແລະ ຢູ່ພາຍໃຕ້ອຳນາດຂອງພຣະອົງ."
      },
      {
        title: "ຕົວຢ່າງຄວາມຍິ່ງໃຫຍ່ຂອງ Al-Malik",
        content: "- ພຣະອົງຊົງເປັນເຈົ້າຂອງຊີວິດ ແລະ ຄວາມຕາຍ: ບໍ່ມີໃຜສາມາດເລືອກວັນເກີດຫຼືວັນຕາຍຂອງຕົນເອງໄດ້, ທັງໝົດແມ່ນການກຳນົດຂອງອັລລໍຮ໌.\n- ຊັບສິນ ແລະ ຄວາມຮັ່ງມີລ້ວນແລ້ວແຕ່ເປັນຂອງພຣະອົງ: ເຖິງແມ່ນວ່າພວກເຮົາຈະຄິດວ່າ \"ສິ່ງນີ້ເປັນຂອງເຮົາ\", ແຕ່ແທ້ຈິງແລ້ວ, ພຣະອົງພຽງແຕ່ມອບໝາຍໃຫ້ພວກເຮົາເບິ່ງແຍງຊົ່ວຄາວ ແລະ ມື້ໜຶ່ງກໍຕ້ອງຄືນກັບພຣະອົງ.\n- ພຣະອົງຊົງກຳນົດກົດເກນຂອງຈັກກະວານ: ດວງອາທິດ, ດວງຈັນ, ດາວຕ່າງໆ ລ້ວນແລ້ວແຕ່ໂຄຈອນຕາມຄຳສັ່ງຂອງພຣະອົງ. ບໍ່ມີສິ່ງໃດຫຼຸດອອກຈາກການຄວບຄຸມ.\n- ບໍ່ມີໃຜສາມາດຂັດຂືນພຣະປະສົງ: ຫາກພຣະອົງປະສົງຈະໃຫ້ບາງສິ່ງເກີດຂຶ້ນ, ມັນກໍຈະເກີດຂຶ້ນທັນທີ ແລະ ຫາກພຣະອົງບໍ່ປະສົງ, ມັນກໍຈະບໍ່ມີວັນເກີດຂຶ້ນ.\n- ໃນໂລກໜ້າ, ພຣະອົງແມ່ນເຈົ້າຂອງການພິພາກສາ: ໃນວັນກິຍາມະຮ໌ (ວັນແຫ່ງການຕັດສິນ), ພຣະອົງຈະຊົງຕັດສິນທຸກດວງວິນຍານຢ່າງຍຸດຕິທຳ. ບໍ່ມີອຳນາດໃດໆທີ່ຈະຊ່ວຍໄດ້, ນອກຈາກພຣະອົງພຽງຜູ້ດຽວ."
      },
      {
        title: "ໃນອັລກຸຣອານ",
        content: "ອັລລໍຮ໌ຊົງກ່າວວ່າ:\n**“ອັລລໍຮ໌ຄືພຣະຜູ້ຊົງເປັນກະສັດສູງສຸດ, ພຣະຜູ້ຊົງສັກສິດ, ພຣະຜູ້ຊົງສັນຕິ, ພຣະຜູ້ຊົງປະທານຄວາມໝັ້ນຄົງ...” (ອັລກຸຣອານ 59:23)**"
      },
      {
        title: "ສຳລັບຊາວມຸດສະລິມໃໝ່",
        content: "- ອັລລໍຮ໌ ແມ່ນເຈົ້າຂອງທຸກສິ່ງທີ່ທ່ານມີ, ສຸຂະພາບ, ຊັບສິນ, ຄອບຄົວ—ທຸກຢ່າງລ້ວນແລ້ວແຕ່ມາຈາກພຣະອົງ.\n- ເມື່ອທ່ານກ່າວ Mālik Yawm ad-Dīn (ພຣະຜູ້ຊົງເປັນເຈົ້າຂອງວັນແຫ່ງການຕອບແທນ) ໃນຊູເຣາະ ອັລ-ຟາຕິຮ໌ະ, ທ່ານກຳລັງຢືນຢັນວ່າຊີວິດນີ້ ແລະ ໂລກໜ້າຂຶ້ນຢູ່ກັບພຣະອົງພຽງຜູ້ດຽວ.\n- ການຍອມຮັບວ່າ ອັລລໍຮ໌ ແມ່ນ Al-Malik ຈະຊ່ວຍໃຫ້ທ່ານຖ່ອມຕົນ, ບໍ່ຫຼົງໃນຊັບສິນຫຼືອຳນາດຊົ່ວຄາວ ແລະ ບໍ່ຢ້ານກົວໃຜນອກຈາກພຣະອົງ."
      },
      {
        title: "✨ ຂໍ້ຄິດທີ່ເຂົ້າໃຈງ່າຍ",
        content: "Al-Malik ໝາຍເຖິງ ອັລລໍຮ໌ແມ່ນເຈົ້າຂອງ ແລະ ກະສັດສູງສຸດຂອງທຸກສິ່ງ. ບໍ່ມີໃຜຍິ່ງໃຫຍ່ຫຼືມີອຳນາດທຽບເທົ່າພຣະອົງໄດ້. ການຍອມຮັບຄວາມຈິງນີ້ຈະເຮັດໃຫ້ຫົວໃຈສະຫງົບ, ວາງໃຈໃນພຣະປະສົງຂອງພຣະອົງ ແລະ ບໍ່ຫຼົງຕິດກັບສິ່ງຊົ່ວຄາວໃນໂລກດຸນຍາ."
      }
    ]
  },
